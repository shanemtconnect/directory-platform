...
export const metadata: Metadata = {
  // ?interval=monthly is the same page with one number swapped. Without a
  // canonical the two compete, and the toggle would cost us the page it sells.
 ...
 *
 * The interval lives in a query string rather than component state so the
 * toggle works with JavaScript disabled or still downloading.
 */
