 ...
 * current copy is deliberately NOT loaded back into the box: the column holds
 * HTML this form does not accept, so showing it would invite an edit that
 * re-saves its own tags as visible text. Saving replaces what is there.
 */
