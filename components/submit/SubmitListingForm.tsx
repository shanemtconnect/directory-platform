    ...
    <form action={action} data-testid="submit-listing-form" className="max-w-2xl">
      ...
      <fieldset>
        ...
        <p>
          ...
          <input id="sl-name" name="name" required maxLength={200}
        ...
        <p>
          ...
          <textarea id="sl-description" name="description" required minLength={50} maxLength={500}
            rows={6} aria-invalid={Boolean(err.description)}
      ...
      <fieldset>
        ...
        <p>
          ...
          <input id="sl-address" name="addressLine1" required maxLength={200}
        ...
        <p>
          ...
          <select id="sl-region" name="region" required aria-invalid={Boolean(err.region)}
            defaultValue="" aria-describedby="sl-region-help">
            <option value="" disabled>Choose one</option>
            {regions.map((r) => (
        ...
        <p>
          ...
          <input id="sl-city" name="city" required maxLength={120}
        ...
        <p>
          ...
          <input id="sl-postcode" name="postcode" required maxLength={16}
      ...
      <fieldset>
        ...
        <p>
          ...
          <input id="sl-phone" name="phone" type="tel" required maxLength={40}
        ...
        <p>
          ...
          <input id="sl-website" name="website" type="text" maxLength={300}
